#!/usr/bin/env python3
"""
CLI entrypoint for sovereign-parts-compare
"""
import sys
import json
import argparse
...
def main():
    parser = argparse.ArgumentParser(description="Intelligent wholesale catalog scraper and pricing intelligence engine. Employs anti-bot evasion techniques, normalizes unstructured supplier SKUs, and uses OpenAI embeddings to reconcile ambiguous OEM part numbers across competing distributors.")
